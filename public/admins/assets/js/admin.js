...
$('#people-all').on('click', function () {
    $("#table-semua").show();
    $("#table-user").hide();
    $('#table-mitra').hide();
    $('#table-diterima').hide();
});
$('#people-users').on('click', function () {
    $("#table-semua").hide();
    $("#table-user").show();
    $('#table-mitra').hide();
    $('#table-diterima').hide();
});
$('#people-mitra').on('click', function () {
    $("#table-semua").hide();
    $("#table-user").hide();
    $('#table-mitra').show();
    $('#table-diterima').hide();
...
$('#dataPengiriman').on('click', function () {
    $('#pengiriman').show();
    $('#umum').hide();
    $('#dataUmum').css('background-color', '');
    $('#dataPengiriman').css('background-color', 'rgba(182, 182, 182, 0.5)');
})
$('#dataUmum').on('click', function () {
    $('#pengiriman').hide();
    $('#umum').show();
    $('#dataUmum').css('background-color', 'rgba(182, 182, 182, 0.5)');
    $('#dataPengiriman').css('background-color', '');
})
